...
parser.add_argument('--easing', type=int, help="Spectify a easing.\n0: none, 1: linear, 2: in-out cubic, 3: 4-point bezier", default=1,choices=[0,1,2,3])
...
parser.add_argument("--offset", help="Specify model midpoint", nargs=3, type=float,default=[0,0,0])
parser.add_argument("--scale", help="Specify the magnification of the model", type=float,default=1)
parser.add_argument("--colorbehavior", help="Specify how the item color behavior overlay should behave.\nFor details, please refer to the explanation in the program or ReadMe.", type=int,default=0,choices=[0,1,2,3])
parser.add_argument("--autorotate", help="Rotation setting for drop.\nFor details, please refer to the explanation in the program or ReadMe.", action='store_true')
parser.add_argument("--autoplay", help="always interpolate frames, colorbehavior=3 overrides this.", action='store_false')
parser.add_argument("--flipuv", help="Invert the UV information.This flag should be set when using models generated by BlockBench.", action='store_true')
