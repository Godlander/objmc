...
objs = [f"{cwd}/ring.obj", f"{cwd}/ring2.obj"]
# texture animations not supported yet
texs = [f"{cwd}/white.png"]
...
out.putpixel(
    (2, 0),
    (
        int(nvertices / 256 / 256 / 256) % 256,
        int(nvertices / 256 / 256) % 256,
...
js = {"textures": {"layer0": output[1]}, "elements": []}
