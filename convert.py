...
parser.add_argument('--frames', help='List of obj indexes as keyframes', nargs=2, default=frames)
parser.add_argument('--out', type=str, help='List of obj indexes as keyframes', nargs='*', default=output)
